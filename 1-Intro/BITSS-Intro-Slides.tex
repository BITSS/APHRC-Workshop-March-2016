...
\begin{itemize}[<.->]
\item Medicine: (Turner et al. 2008)
\item Social Sciences: (Franco, Malhotra, Simonovits 2014)
\item Economics: (Brodeur et al. 2016)
\item Sociology: (Gerber and Malhotra 2008)
\item Political Science: (Gerber and Malhotra 2008)
\end{itemize}
\end{frame}
